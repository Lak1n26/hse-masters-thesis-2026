...
def main(
    ...
    # train_val_grouped = pd.concat([train_grouped, val_grouped], ignore_index=True)
    ...
    train_dataset = TrainDataset(dataset=data.trainval, num_items=num_items, max_seq_len=max_seq_len, interactions_col='train_val_interactions')
